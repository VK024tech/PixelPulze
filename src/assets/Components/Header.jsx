...
export default function Header() {
  ...
  const navOption = ["Home", "Contact", "Pricing"];

  function navShow() {
    return navOption.map((curr) => {
      return (
        <a key={curr} className="group relative py-2 px-4 cursor-pointer  rounded-md">
  ...
  return (
    <header className="md:fixed md:right-[50%] md:top-4 md:translate-x-[50%] md:rounded-md shadow-xs/90 shadow-gray-500  items-center  flex gap-12 justify-between  px-8 dark:bg-gray dark:text-white bg-white text-gray">
